...
public class TestPatronBuilder {
    public static void main(String[] args) {
        ...
        personaValoresPorDefecto = constructorDePersonas.contruir();
        ...
        personaSoloConDireccionEdad = constructorDePersonas.direccion("Dirección nueva").edad(34).contruir();
        ...
        personaCompleta = constructorDePersonas.nombre("Pepito").direccion("Casa de Pepito").edad(51).contruir();
